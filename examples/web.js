...
(function() {
  var async, configureLogging, configureRestless, createExpress, express, inspect, namespace, processSeriesResult, resourced, startExpress, winston;
  ...
  configureRestless = function(done) {
    return resourced.configureResourcesInDirectory(__dirname + '/resources', done);
  };
