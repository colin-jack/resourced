...
var registerAllResourcesInDirectory = function * (directoryPath, express, dependencyResolver) {
    ...
    try {
        ...
        logErrorAndRethrow(err, directoryPath);
    }
};
...
var logErrorAndRethrow = function (err, directoryPath) {
    var message = format("Configuration for '%s'. Exception: '%s'.", directoryPath, err)
