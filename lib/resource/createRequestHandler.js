var _u = require('underscore'),
    populateArgumentsFromRequest = resourcedLib.require('populateArgumentsFromRequest'),
    ...
    validateUrl = resourcedLib.require('validateUrl'),
    validateBody = resourcedLib.require('validateBody'),
