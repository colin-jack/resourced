...
var populateArgumentsFromRequest = function(request, handlerMethod) {
    ...
    for (var i = 0, paramCount = handlerArgumentNames.length; i < paramCount; i++) {
        ...
        // Use undefined for all but last argument. No use pushing undefined for last argument, it'll implicitly
        // be undefined if we do nothing and also elsewhere we may want to push the request body into last argument 
        // if we do that for this kind of request
