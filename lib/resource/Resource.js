...
Resource.prototype.getUrl = function(uriParams) {
    var relativeUrl = urlCreator.createUrl(this.resourceDefinition, uriParams);
...
var createAbsoluteUrl = function createAbsoluteUrl(relativeUrl) {
