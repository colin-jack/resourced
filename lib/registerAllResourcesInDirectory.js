...
var createDirectoryContentsProcessor = function(directoryPath, express) {
    return function(err, contents) {
        ...
        async.forEach(contents, addResourcesFromDirectory);
    }
};
...
var processFileOrDirectory = function(fileOrDirectory, parentDirectory, express, fileOrDirectoryDone) {
    ...
    fs.stat(fullPathToFile, function(err, fileStats) {
        ...
        try {
            ...
            processFileStats(fileStats, fullPathToFile, fileOrDirectory, express, fileOrDirectoryDone);
        } catch(err) {
