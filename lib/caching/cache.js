...
// Default to caching privately but give options to over-ride that behavior.
var getLocationOptions = function(seconds) {
    var cachingDefinition = new CachingDefinition(seconds, "private");

    var locationFluentInterface = {
        publically : function() { return new CachingDefinition(seconds, "public"); },
        privately : function() { return this; }
    };
